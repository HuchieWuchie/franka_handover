...
from fhUtils.visualize import visualizeGrasps6DOF, visualizeMasksInRGB, visualizeBBoxInRGB
from fhUtils.visualize import visualizeMasksInRGB, visualizeFrameMesh, createGripper, visualizeGripper, visualizeMeshInRGB, visualizeGraspInRGB
from fhUtils.affordancetools import getPredictedAffordances, getAffordanceContours, getObjectAffordancePointCloud, getPointCloudAffordanceMask
...
if __name__ == '__main__':
    ...
    print("Init")
    rospy.init_node('fh_handover_node', anonymous=True)
    ...
    while True:
        ...
        if state == 1:
            ...
            if True in success:
                ...
                T_world_2_cam, _, _ = transform.getTransform("world", "camera_robot_camera_color_optical_frame")
                        ...
                        if valid_grasp:
                            ...
                            while x_pos <= x_range:
                                ...
                                while rot_num <= rot_range:
                                    ...
                                    valid_handover, state_handover = robot.getInverseKinematicsSolution(state_ready, ee_pose)
